...
application.wsgi_app = ProxyFix(application.wsgi_app,num_proxies=2)
	...
	if request.method == "POST":
		...
		if seq1 and seq2:
			try:
				...
				errors.append("An error occurred. It would be appreciated if you could send the details of the sequences you were querying to hodgens@email.unc.edu so that the issue can be replicated and the problem can be fixed.")
				errors.append(e)
				return(render_template('results.html',allResults=[],notes=errors))
